...
export default function GameToolbarNew() {
  const {
    puzzleDetails,
    step,
    isSoundOn,
  ...
  return (
    <div className="border-y border-sleek-secondary sticky bg-sleek-primary font-second text-neutral-22">
              ...
              <div className="flex flex-row items-center h-full text-neutral-22">
                {isUserAdmin && (
                  <button
                    ...
                    } border-none h-full flex px-2.5 items-center text-lg`}
                  >

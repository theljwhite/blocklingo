...
export default function Profile() {
  ...
  return (
    <LayoutTile>
      <div className="grow shrink overflow-x-hidden overflow-y-auto min-h-[0px] font-second">
        <div className="min-w-[600px] md:min-w-[900px] xl:min-w-[1320px] w-full px-8 py-10 mx-auto flex flex-col gap-6">
          <div className="backdrop-blur-md bg-transparent rounded-lg p-6 justify-between flex-wrap border border-zinc-700 gap-3 flex">
                      ...
                      >
                        {achievements.map((achievement) => {
                          return (
                            <div
                              key={achievement.id}
                              className="relative grid p-6 rounded-lg bg-neutral-24"
                            >
